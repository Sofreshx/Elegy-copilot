...
describe('Sidebar - Main Mode', () => {
  it('renders main nav items: Workspace, Lexicon, Repositories', () => {
    render(
      <Sidebar
...
describe('Sidebar - Collapse toggle', () => {
  ...
  it('hides labels when collapsed in main mode', () => {
    ...
    const workspaceBtn = screen.getByTestId('sidebar-item-workspace');
    expect(workspaceBtn.querySelector('.sidebar-item-label')).toBeNull();

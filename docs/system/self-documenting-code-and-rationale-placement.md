...
- Promote durable workflow or rule guidance into [[project-conventions-governance]] [project-conventions-governance.md](project-conventions-governance.md) or the smallest sibling canonical node that owns the rule family. [project-conventions-governance](docs/system/project-conventions-governance.md)

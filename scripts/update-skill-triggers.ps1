...
$triggerMap = @{
  ...
  'cloudflare-deploy'         = @('Cloudflare deploy','Cloudflare Pages','Cloudflare Workers','Wrangler','Cloudflare hosting')
  ...
  'firebase-mcp'              = @('Firebase MCP','firebase mcp','firebase tools mcp','firebase cli mcp','firebase management')
  'frontend'                  = @('UI','component','React','Vue','page','frontend')
  'infra-settings'            = @('MCP settings','MCP providers','mcp config','infra settings','provider settings')
  ...
  'supabase-mcp'              = @('Supabase','Supabase MCP','supabase mcp','supabase project','supabase database')
  ...
  'vultr-mcp'                 = @('Vultr','vultr mcp','vultr api','vultr server','vultr infrastructure')

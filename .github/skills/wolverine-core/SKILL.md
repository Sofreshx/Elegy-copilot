---
name: wolverine-core
description: "Wolverine message handling and CQRS. Creates handlers, commands, events, and message processing. Use for 'Wolverine handler', 'message bus', 'CQRS', or Wolverine messaging tasks."
tools: ['read', 'edit', 'search']
sources:
  - https://wolverinefx.net/guide/basics.html
---

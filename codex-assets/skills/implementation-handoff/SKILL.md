...
Use this skill after a normal plan exists and before code changes begin when a different model, lower-context session, or future Codex run may implement the work.

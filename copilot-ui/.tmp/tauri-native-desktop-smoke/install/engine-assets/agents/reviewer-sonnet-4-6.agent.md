...
description: Cross-model planning reviewer (Sonnet 4.6). Validates plans and planning-workflow summaries for accuracy, gaps, and risks. Use as an opposite-model check.
tools: [read, search]
...
# Cross-Model Reviewer (Sonnet 4.6)

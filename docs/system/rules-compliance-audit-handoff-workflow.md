...
1. **Bootstrap canonical repo rules first.**
    - Start from [[system-docs-index]] [docs/system/index.md](docs/system/index.md) and
      [[moc-conventions-and-governance]]
      [docs/system/mocs/conventions-and-governance.md](docs/system/mocs/conventions-and-governance.md),
...
3. **Run project audit as a composed family.**
   - Use the specialist lanes defined in [[reviewer-lane-governance]]
     [docs/system/reviewer-lane-governance.md](docs/system/reviewer-lane-governance.md) as an

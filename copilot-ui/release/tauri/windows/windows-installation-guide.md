...
- Desktop version: 1.0.3
- Release channel: stable
- Windows installer: Elegy Copilot_1.0.3_x64-setup.exe
...
1. Download the matching-channel Windows installer (`Elegy Copilot_1.0.3_x64-setup.exe`).

...
(0, node_test_1.default)('gateway child mode is detected from process args', () => {
    strict_1.default.equal((0, gatewayChildMode_1.hasGatewayChildFlag)(['electron', '.', gatewayChildMode_1.GATEWAY_CHILD_FLAG]), true);
    strict_1.default.equal((0, gatewayChildMode_1.hasGatewayChildFlag)(['electron', '.']), false);
});
...
(0, node_test_1.default)('gateway child flag is stripped before handing argv to the gateway cli', () => {
    strict_1.default.deepEqual((0, gatewayChildMode_1.stripGatewayChildFlag)(['electron', '.', gatewayChildMode_1.GATEWAY_CHILD_FLAG, '--mode=disconnected']), ['electron', '.', '--mode=disconnected']);
});

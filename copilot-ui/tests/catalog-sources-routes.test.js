...
async function run() {
  ...
  const externalSources = {
    listSources: () => ({
      ...
      userSourcesPath: 'C:\\.elegy\\catalog\\external-sources\\user-sources.json',
      statePath: 'C:\\.elegy\\catalog\\external-sources\\state.json',
      sources: [
        {
    ...
    resolveCacheRoot: (elegyHome) => path.join(elegyHome, 'catalog', 'external-sources', 'cache'),
  };
    ...
    const summaryRoutes = register({
      ...
      catalogProjection: {
        resolveProjectionStorage: () => ({
          catalogRoot: 'C:\\.elegy\\catalog',
          snapshotPath: 'C:\\.elegy\\catalog\\snapshot.json',
          elegyHome: 'C:\\.elegy',
          repoContext: null,
        }),

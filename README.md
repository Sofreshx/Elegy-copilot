...
| `@e2e-ux-auditor Run an E2E UX audit` | Custom agent + `chrome-devtools-mcp` | Drive a real Chrome browser, report UX/feature gaps, sync to tasks |
...
- [Windows E2E setup (chrome-devtools-mcp)](docs/windows-10-ltsc-iot-e2e-chrome-devtools-mcp.md)

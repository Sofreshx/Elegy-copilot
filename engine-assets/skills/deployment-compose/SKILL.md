...
description: "Docker Compose configuration. Creates and modifies docker-compose.yml for local development and deployment. Triggers on: docker, compose, docker compose, container, containers."
---

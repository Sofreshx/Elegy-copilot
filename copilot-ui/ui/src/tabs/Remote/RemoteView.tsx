...
export default function RemoteView() {
  ...
  const connectionTone = statusTone(connectionState);

  return (
    <div className="view-shell remote-view" data-testid="remote-view">
      <div className="view-static remote-sticky-header">
        <Toolbar testId="remote-toolbar" wrap>
          <div className="remote-toolbar-heading">
            <span className="kicker">Discord connection</span>
            <h2>Remote Sessions</h2>
          </div>
          <div className="remote-toolbar-actions">
            <StatusBadge
      ...
      <div className="view-scroll remote-scroll">
        <PageContainer>
          <div className="remote-shell">
            ...
            {!isReady ? (
              ...
              <>
                ...
                >
                  <div className={`connection-rail connection-rail--${connectionState}`}>

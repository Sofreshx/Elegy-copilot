...
- narrow exception: the shared shipped `repo-setup-governance-global` bundle may install the `repo-setup-governance` skill into the user-global surface for audit/propose-only repo setup governance across explicit open workspace roots

...
[session-state-artifacts.md](docs/system/session-state-artifacts.md). Separate
...
[goal-contract-governance.md](docs/system/goal-contract-governance.md), using
...
Key architectural, trust-boundary, workflow-authority, or long-lived contract decisions that future work will rely on should be checked against [[adr-governance]] [adr-governance.md](docs/system/adr-governance.md) instead of staying only inside the plan pack.
...
- The plan pack is **read-only** during execution. Progress is tracked in the appended `# Plan-Pack Progress Tracker`
  ...
  [session-state-artifacts.md](docs/system/session-state-artifacts.md)).
...
See [[validation-governance]] [validation-governance.md](docs/system/validation-governance.md)
...
[[session-state-artifacts]] [session-state-artifacts.md](docs/system/session-state-artifacts.md)

---
name: merger
description: "DEPRECATED — Merger agent removed (branch-modifying behavior). Do not invoke; use manual merge conflict resolution or open a PR for human review."
tools: ['read', 'edit', 'search']
user-invocable: false
disable-model-invocation: true
---

# DEPRECATED — merger agent removed

This agent has been disabled and removed from the CLI manifest by repository policy (branch-changing agents are prohibited). It remains in the repository for historical reference only — do not invoke or rely on it.

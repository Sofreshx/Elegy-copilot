...
- Staged routing stays in [search-execute-workflow.md](search-execute-workflow.md), planning-surface authority stays in [planning-backlog-roadmap-contract.md](planning-backlog-roadmap-contract.md), and lane-specific outputs stay in their existing contracts.
...
step and promote the durable decision through the owning canonical doc or [[adr-governance]] [adr-governance.md](docs/system/adr-governance.md) when needed.
...
- No overlay may bypass the staged routing and canonical bootstrap posture in [search-execute-workflow.md](search-execute-workflow.md).
- Model capability profiles may influence which model handles an already-selected overlay, but they do not authorize the overlay by themselves. See [model-capability-profile.md](model-capability-profile.md).
- Skills or prompts may support an already-selected overlay, but they do not create a parallel routing hierarchy or a second default mode. See [skills-governance.md](skills-governance.md).
...
| Follow-up discovery | Route challenged assumptions, evidence gaps, and blocking unknowns into `immediate_next_tasks`, `gaps`, or `research_threads` under [follow-up-discovery-governance.md](follow-up-discovery-governance.md). |
...
- [planning-backlog-roadmap-contract.md](planning-backlog-roadmap-contract.md)
- [planpack-spec.md](planpack-spec.md)
- [skills-governance.md](skills-governance.md)
- [model-capability-profile.md](model-capability-profile.md)

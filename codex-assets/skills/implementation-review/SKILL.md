...
description: "Implementation review for Codex changes. Use after code, docs, skills, agents, or configuration edits; use when asked to review implementation, check diff, verify done criteria, or assess whether changes match the plan."
---
...
5. Verify new instructions or skills are concise, scoped, and not duplicating what Codex can discover from code.

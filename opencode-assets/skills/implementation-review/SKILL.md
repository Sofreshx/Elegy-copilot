...
description: "Implementation review for OpenCode changes. Use after code, docs, skills, agents, or configuration edits; use when asked to review implementation, check diff, verify done criteria, or assess whether changes match the plan."
---
...
5. Verify new instructions or skills are concise, scoped, and not duplicating what OpenCode can already handle directly.

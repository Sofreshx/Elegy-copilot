...
## Purpose
Leaf-only lane for repo-backed planning artifacts above execution: Repository Backlog (`~/.copilot/backlogs/{repo-name}/backlogs/*.md`) and Roadmaps (`~/.copilot/backlogs/{repo-name}/roadmaps/<slug>.md`). Organizes intake, phased outcomes, and sync-ready cross-links.
...
- `~/.copilot/backlogs/{repo-name}/backlogs/*.md` + `~/.copilot/backlogs/{repo-name}/roadmaps/` are authoritative; `docs/backlog.md` is deprecated legacy.

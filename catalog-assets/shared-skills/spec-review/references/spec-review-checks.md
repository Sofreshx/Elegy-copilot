...
18. **Spec-to-planning handoff:** If the spec is `approved`, confirm it links to an active plan or work point through `Implementation Links` and the file-scope selector defined by normative spec R10. Draft specs may defer this; approved specs must have it.

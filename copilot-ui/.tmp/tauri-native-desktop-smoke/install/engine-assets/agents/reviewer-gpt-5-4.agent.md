...
description: Cross-model planning reviewer (GPT-5.4). Validates plans and planning-workflow summaries for accuracy, gaps, and risks. Use as an opposite-model check.
tools: [read, search]

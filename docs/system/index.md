...
- [[ui-development-governance]] [ui-development-governance.md](ui-development-governance.md)
- [[ui-check-adoption]] [ui-check-adoption.md](ui-check-adoption.md)
- [[catalog-control-plane]] [catalog-control-plane.md](catalog-control-plane.md)
- [[architecture-overview]] [architecture-overview.md](architecture-overview.md)
- [[opencode-guide]] [opencode-guide.md](opencode-guide.md)
- [[ghcp-guide]] [ghcp-guide.md](ghcp-guide.md)
- [[repo-skill-sync-governance]] [repo-skill-sync-governance.md](repo-skill-sync-governance.md)
- [[project-conventions-governance]] [project-conventions-governance.md](project-conventions-governance.md)
- [[progressive-constraint-narrowing]] [progressive-constraint-narrowing.md](progressive-constraint-narrowing.md)
- [[adr-governance]] [adr-governance.md](adr-governance.md)
- [[spec-driven-development]] [spec-driven-development.md](spec-driven-development.md)
- [[commit-validation-governance]] [commit-validation-governance.md](commit-validation-governance.md)
...
- [[windows-shell-optimization]] [windows-shell-optimization.md](windows-shell-optimization.md)

## MOCs

- [[orchestration-and-agents]] [mocs/orchestration-and-agents.md](mocs/orchestration-and-agents.md)
- [[moc-conventions-and-governance]] [mocs/conventions-and-governance.md](mocs/conventions-and-governance.md)
- [[moc-skills-governance]] [mocs/skills-governance.md](mocs/skills-governance.md)
- [[testing-and-e2e]] [mocs/testing-and-e2e.md](mocs/testing-and-e2e.md)
- [[security-model-and-safety]] [mocs/security-model-and-safety.md](mocs/security-model-and-safety.md)

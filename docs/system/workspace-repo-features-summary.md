...
status: current
doc_kind: node
id: workspace-repo-features-summary
summary: Summary of workspace and repository management features added to Elegy Copilot.
tags: [workspace, repo, features, summary]
---

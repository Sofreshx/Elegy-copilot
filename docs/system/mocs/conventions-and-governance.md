...
- End-to-end first-slice overview for repo-rule bootstrap, compliance, project audit, follow-up
  ...
  [[rules-compliance-audit-handoff-workflow]] [rules-compliance-audit-handoff-workflow](docs/system/rules-compliance-audit-handoff-workflow.md)
...
- Placement matrix for self-documenting code, smart comments, doc comments, ADRs, and thin
  ...
  [[self-documenting-code-and-rationale-placement]] [self-documenting-code-and-rationale-placement](docs/system/self-documenting-code-and-rationale-placement.md)
...
- System docs entrypoint: [[system-docs-index]] [../index.md](../index.md) [system-docs-index](docs/system/index.md)
